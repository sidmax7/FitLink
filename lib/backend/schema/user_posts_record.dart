...
class UserPostsRecord extends FirestoreRecord {
  ...
  // "workoutProfile" field.
  DocumentReference? _workoutProfile;
  DocumentReference? get workoutProfile => _workoutProfile;
  bool hasworkoutProfile() => _workoutProfile != null;
  ...
  void _initializeFields() {
    ...
    _workoutProfile = snapshotData['workoutProfile'] as DocumentReference?;
...
Map<String, dynamic> createUserPostsRecordData({
  ...
  DateTime? timePosted,
  int? numComments,
  DocumentReference? workoutProfile,
  bool? postOwner,
}) {
...
class UserPostsRecordDocumentEquality implements Equality<UserPostsRecord> {
  ...
  bool equals(UserPostsRecord? e1, UserPostsRecord? e2) {
    ...
    return e1?.postPhoto == e2?.postPhoto &&
        ...
        e1?.workoutProfile == e2?.workoutProfile &&
