...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'createworkoutProfile',
          path: '/createworkoutProfile',
        ...
        FFRoute(
          name: 'editworkoutProfile',
          path: '/editworkoutProfile',
          asyncParams: {
            'workoutProfile': getDoc(['workouts'], workoutsRecord.fromSnapshot),
          },
          builder: (context, params) => EditworkoutProfileWidget(
            workoutProfile: params.getParam('workoutProfile', ParamType.Document),
          ),
        ),
        FFRoute(
          name: 'changePassword',
        ...
        FFRoute(
          name: 'createworkoutProfile_New',
          path: '/createworkoutProfileNew',
